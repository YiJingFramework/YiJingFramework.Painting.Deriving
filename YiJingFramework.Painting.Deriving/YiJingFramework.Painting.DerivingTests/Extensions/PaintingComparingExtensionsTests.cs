    ...
    public class PaintingComparingExtensionsTests
    {
        ...
        public void IsOverturnedFromTest()
        {
            for (int i = 0; i < 1000; i++)
            {
                ...
                Assert.IsTrue(
                    new Core.Painting(((IEnumerable<Core.YinYang>)r1).Reverse()).IsOverturnedFrom(
                    new Core.Painting(r1)));
                Assert.IsFalse(
                    new Core.Painting(((IEnumerable<Core.YinYang>)r1).Reverse()).ChangeLines(0).IsOverturnedFrom(
                    new Core.Painting(r1)));
            }
        }
    }
